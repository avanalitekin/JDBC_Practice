...
public class JDBCOnMyPostGreSQLDB {
	...
	connection=DriverManager.getConnection(getProperty("mypostgredb_url"),getProperty("mypostgredb_un"),getProperty("mypostgredb_pw"));
